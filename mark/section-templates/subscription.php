<?php
global $mark_section;
$mark_section_meta = get_post_meta($mark_section['section'], 'mark_section_type_subscription', true);
?>
			...
			<div class="col-md-12">
				<form target="_blank" method="post" action="<?php echo esc_url($mark_section_meta['url']); ?>" class="form-inline row">
					...
					<div class="form-group col-lg-3 col-md-3">
						<button type="submit" class="btn btn-block btn-primary-solid"><?php echo esc_html($mark_section_meta['btn_label']); ?></button>
					</div>
				</form>
			</div>
		</div>
